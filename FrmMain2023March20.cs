...
namespace NumberProcessor_Global_2022
{
    public partial class FrmMain : Form
    {
        ...
        private int NUM_OF_THREADS = 25;//1,30
        ...
        private List<string[]> BatchScanFilter(List<string[]> inputRows, int targetNumCols, dynamic filterParam)
        {
            ...
            for (int i = 0; start && i < inputRows.Count; i++)//, m++)
            {
                ...
                for (int j = 0; j < batchRows.Count; j++)//////////////////////////////////////////////////
                {
                    ...
                    if (haveIndices)
                    {
                        ...
                        if (absolute)
                        {
                            ...
                            if (mCount == batchMinMatch || mCount == colIndices.Count)
                            {
                    ...
                    if (modula)
                    {
                        ...
                        foreach (string br in batchRow.Intersect(inputRow))
                        {
                            mCount++;
        ...
        private List<string[]> SummationFilter(List<string[]> inputRows, int targetNumCols, dynamic filterParam)
        {
            ...
            //bool batchMean = chkBatchMean.Checked;
            bool sumRetainMatched = filterParam.sumRetainMatched;
            //bool outliers = chkOutliers.Checked;
            ...
            bool powerBatch = chkPowerBatch.Checked; bool powerOption = chkPowerOpt.Checked;
            ...
            List<string[]> batchRows = filterParam.batchRows; FilterLogInfo logInfo = filterParam.logInfo; List<string[]> outputRows = new List<string[]>(); List<int> colIndices = null;
            ...
            if (start)
            {
...

                {
                    ...
                    for (int i = 0; i < inputRows.Count; i++)
                    {
...

                        {
                            ...
                            //string[] batchRow = new string[5]; bool hE = chkHE.Checked;
                            bool hO = chkHO.Checked;
                            bool hE = chkHO.Checked;
                            ...
                            bool isModUnMod = chkModUnmod.Checked;
...

                            {
                                ...
                                if (isCoupled_Rows)
                                {
                                    ...
                                    if (higH)
                                    {
                                        ...
                                        string[] partialinputRow = inputRow;
                                        string[] completeInputRow = partialinputRow;
                                        ...
                                        for (int k = 0; k < inputRow.Length; k++)
                                        {
                                            ...
                                            foreach (string br in highGroup.Intersect(batchRow))
                                            {
                                                if (br == inputRow[k])
                                                {
                                                    highCount++;
                                            ...
                                            if (highCount == numHighCount.Value)
                                            {
                                        ...
                                        for (int tk = 0; tk < numDelinCount.Value; tk++)
                                        {

                                            string[] btch = batchRows[tk];

                                             loWCount = 0;
                                            for (int kk = 0; kk < partialinputRow.Length; kk++)
                                            {

                                                foreach (string lows in lowGroup.Intersect(btch))
                                                {
                                                    if (int.Parse(lows) == int.Parse(partialinputRow[kk]))
                                                    {
                                                    ...
                                                    if (absolute)
                                                    {
                                                        if (highCount == numHighCount.Value && loWCount == numLowCount.Value)
                                                        {
                                    ...
                                    if (hO)//Low
                                    {
                                        ...
                                        for (int k = 0; k < inputRow.Length; k++)
                                        {
                                            ...
                                            foreach (string br in highGroup.Intersect(batchRow.Take(5)))
                                            {

                                                if (int.Parse(inputRow[k]) == int.Parse(br)) ////
                                                {
                                                    highCount++;
                                                }
                                            }
                                        ...
                                        for (int kk = 0; kk < inputRow.Length; kk++)
                                        {
                                            foreach (string br1 in lowGroup.Intersect(batchRow.Take(5)))
                                            {
                                                if (int.Parse(inputRow[kk])  == int.Parse(br1)) ////
                                                {
                                    ...
                                    if (hO)//Low
                                    {
                                        ...
                                        for (int k = 0; k < inputRow.Length; k++)
                                        {
                                            ...
                                            foreach (string br in hOGroup.Intersect(batchRow.Take(5)))
                                            {
                                            ...
                                            for (int kk = 0; kk < inputRow.Length; kk++)
                                            {
                                                foreach (string br1 in hEGroup.Intersect(batchRow.Take(5)))
                                                {
                                                    if (int.Parse(inputRow[kk]) == int.Parse(br1)) ////
                                                    {
                                        ...
                                        if (absolute)
                                        {
                                            ...
                                            if (hOCount == numHOCount.Value)

                                            {
                                                if (hECount == numHECount.Value)
                                                {
                                                    outputRows.Add(inputRow);
                                                    inputRows.RemoveAt(i);
                                                    --i;
                                    ...
                                    if (lO)//Low
                                    {
                                        ...
                                        for (int k = 0; k < inputRow.Length; k++)
                                        {
                                            ...
                                            foreach (string br in lOGroup.Intersect(batchRow.Take(5)))
                                            {
                                        ...
                                        for (int kk = 0; kk < inputRow.Length; kk++)
                                        {
                                            foreach (string br1 in lEGroup.Intersect(batchRow.Take(5)))
                                            {
                                                if (int.Parse(inputRow[kk]) == int.Parse(br1)) ////
                                                {
                                        ...
                                        if (absolute)
                                        {
                                            ...
                                            if (lOCount == numLOCount.Value)

                                            {
                                                if (lECount == numLECount.Value)
                                                {
                                                    outputRows.Add(inputRow);
                                                    inputRows.RemoveAt(i);
                                                    --i;
                                    ...
                                    if (oDD)//Low
                                    {
                                        ...
                                        for (int k = 0; k < inputRow.Length; k++)
                                        {
                                            ...
                                            foreach (string br in oDDGroup.Intersect(batchRow.Take(5)))
                                            {

                                                if (int.Parse(inputRow[k]) % 10 == int.Parse(br) % 10) ////
                                                {
                                                    oDDCount++;
                                                }
                                            }
                                            ...
                                            //for (int kk = 0; kk < inputRow.Length; kk++)
                                            //{
                                            foreach (string br1 in eVNGroup.Intersect(batchRow.Take(5)))
                                            {
                                                if (int.Parse(inputRow[k]) % 10 == int.Parse(br1) % 10) ////
                                                {
                                                    eVNCount++;
                                        ...
                                        if (absolute)
                                        {
                                            ...
                                            if (oDDCount == numoDDCount.Value)

                                            {
                                                if (eVNCount == numEVNCount.Value)
                                                {
                                                    outputRows.Add(inputRow);
                                                    inputRows.RemoveAt(i);
                                                    --i;
                                ...
                                if (isUnCoupled_Rows)
                                {
                                    ...
                                    if (loW)
                                    {
                                        ...
                                        for (int k = 0; k < inputRow.Length; k++)
                                        {
                                            ...
                                            foreach (string br in lowGroup.Intersect(batchRow.Take(5)))
                                            {
                                    ...
                                    if (hE)
                                    {
                                        ...
                                        for (int k = 0; k < inputRow.Length; k++)
                                        {
                                            ...
                                            foreach (string br in hEGroup.Intersect(batchRow.Take(5)))
                                            {
                                    ...
                                    if (lE)
                                    {
                                        ...
                                        for (int k = 0; k < inputRow.Length; k++)
                                        {
                                            ...
                                            foreach (string br in lEGroup.Intersect(batchRow.Take(5)))
                                            {
                                    ...
                                    if (eVN)
                                    {
                                        ...
                                        for (int k = 0; k < inputRow.Length; k++)
                                        {
                                            ...
                                            foreach (string br in eVNGroup.Intersect(batchRow.Take(5)))
                                            {
...

                {
                    ...
                    if (haveIndices)/////////////////////////////////////////////
                    {
                        ...
                        for (int kk = batchRows.Count - 2; kk > -1; kk--)
                        {
                            ...
                            for (int i = inputRows.Count - 2; i > -1; i--)
                            {
                                string[] inputRow = inputRows[i];
                ...
                if (colSums)
                {
                    ...
                    for (int i = 0; i < inputRows.Count; i++)//, m++)
                    {
                        string[] inputRow = inputRows[i];
        ...
        private void btnGenStart_Click(object sender, EventArgs e)
        {
            if (!start)
            {
                ...
                int objsLen = isCombTypeA || isCombTypeA1 || isCombTypeA2 || isCombTypeA3 ? 70 : 50;
        ...
        private void CountingThreadMethod(object obj)
        {
            ...
            bool twoPlus = chkTwoPlus.Checked;
            bool threePlus = chkThreePlus.Checked;
            bool fivePlus = chkFivePlus.Checked;
            FileStream readerFS = ((dynamic)obj).readerFS;
                ...
                foreach (string[] row in inputRows)
                {
                    ...
                    else
                    {
...

                        {
                            ...
                            foreach (string inp1col in rowInput1Arr)
                            {
                                for (int i = 0; i < colList1.Count - 2; i++)//PLEASE DO NOT WORRY IT IS PERFECT THE WAY IT IS(with COUNT-1)
                                                                            // Please check the input file before you become unnecessarily stressed)
                                                                            // Please Remember TypeA Counts file with 6 coloumns- TypeB only counts
                                                                            // ACCURATELY input-files with 5 or less coloumns//
                                                                            // TYPE B counts accurately for powa plus. //
                                {
...

                    {
                        ...
                        if (twoPlus) // length 4 
                        {
                            ...
                            if (rowInput22[0] == colList[2] && rowInput22[1] == colList[3] || rowInput22[1] == colList[2] && rowInput22[0] == colList[3]) //PLEASE DO NOT WORRY IT IS PERFECT THE WAY IT IS()
                            {
                        ...
                        if (threePlus)
                        {
                            ...
                            if (rowInput22[0] == colList[3] && rowInput22[1] == colList[4] || rowInput22[1] == colList[3] && rowInput22[0] == colList[4]) //PLEASE DO NOT WORRY IT IS PERFECT THE WAY IT IS()
                            {
                                found = true;
                        ...
                        if (fivePlus)// foreach (string br in inputRow.Intersect(batchRow))
                        {

                            if (rowInput22[0] == colList[4] || rowInput22[1] == colList[3])//|| rowInput22[1] == colList[4] && rowInput22[0] == colList[3])  //PLEASE DO NOT WORRY IT IS PERFECT THE WAY IT IS()
                            {
                                found = true;
                        ...
                        {
                            if (rowInput22[0] == colList.Last() || rowInput22[1] == colList.Last()) //PLEASE DO NOT WORRY IT IS PERFECT THE WAY IT IS()
                            {
                                found = true;
        ...
        private void txtDisplayCounted_TextChanged(object sender, EventArgs e)
        {
